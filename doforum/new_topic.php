 ...
 <div class="row">
  ...
  <ul>
			<li><a href="../doforum">Forum Home</a></li>
                  ...
                  <li class="active"> <a class="item" href="/doforum/new_topic.php">Create a topic</a></li>
                  <li class="divider-vertical"></li>
...
else
{
		...
		else
		{
			...
			else
			{
				...
				?> <form method="post" action="">
					...
					<h2><span class="label label-important">Select a most apropriate Category for your topic </span><span class="label label-success"> : Must</span></h2>
				     Category:<br>
			<select name="topic_cat">';
							<option value="<?php echo $catid;?>" SELECTED>Click Here & Select </option>
	...
	else
	{
		...
		{	 $topex= $_POST['topic_subject'];
		     if($topex === ""){        
             echo '<h2> You have not entered a topic name, Please go back and Enter a topic name first. </h2><hr>'  ;   
			...
			if(!$result)
			{
				//something went wrong, display the error
					echo '<h2> You have not selected a Category from the dropdown list (to define the category of your topic), Please go back and Select a Category name first. </h2><hr>'   ;
